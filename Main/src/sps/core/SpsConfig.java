...
public class SpsConfig {
    ...
    public final boolean devTimeStates;
    public final boolean optCollectMetaData;
    public final boolean optEnableFontOutlines;


    private SpsConfig() {
        try {
            Logger.info("Parsing sps-gamelib.cfg");
            for (String line : FileHelper.readLines(Loader.get().asset("data", "sps-gamelib.cfg"))) {
        ...
        devTimeStates = Parse.bool(_settings.get("devTimeStates"));
        optCollectMetaData = Parse.bool(_settings.get("optCollectMetaData"));
        optEnableFontOutlines = Parse.bool(_settings.get("optEnableFontOutlines"));
    }
}